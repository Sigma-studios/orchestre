...
| Voice | Grunts, yells, groans, animal calls, monsters, and the sounds that are not vowels: a growled *grrr*, *shh*, *hmm*, *brrr*, a hiss. Klatt's (1980) cascade/parallel formant synthesizer: a Liljencrants–Fant vocal-fold source (pressed ↔ breathy) through five formants, with curves over time for pitch, vowel, voice quality and loudness, plus roughness, subharmonics, split voices and a flutter that can trill. The *Klatt* section sets formants and bandwidths by hand (an r is a low F3), voicing, breath and hiss over time, the parallel formants that shape a hiss into s, sh or f, and the nose (m, n). Expressive, but still recognizably synthetic |
